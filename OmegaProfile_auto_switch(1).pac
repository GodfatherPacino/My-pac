var FindProxyForURL = function(init, profiles) {
    ...
    "+__ruleListOf_auto switch": function(url, host, scheme) {
        ...
        if (/^http:\/\/archive\.is/.test(url)) return "+proxy";
        ...
        if (/^http:\/\/expressvpn\.com/.test(url)) return "+proxy";
        ...
        if (scheme === "http" && url.indexOf("m.huaren4us.com") >= 0) return "+proxy";
        ...
        if (/^https:\/\/ozvoice\.org/.test(url)) return "+proxy";
        ...
        if (scheme === "http" && url.indexOf("steamcommunity.com/profiles/76561198062771609") >= 0) return "+proxy";
